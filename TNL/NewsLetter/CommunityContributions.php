...
/**
 * Get the CommunityContributions Category Posts.
 */
class TNL_NewsLetter_CommunityContributions
{
  /**
  ...
  public function getNewsPosts( $args = []) {
    ...
    $news_posts =  TNL_ACF_Fields::get_instance()->getFields( 'community_contributions', $post_id );
